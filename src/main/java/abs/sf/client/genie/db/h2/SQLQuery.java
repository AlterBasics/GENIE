...
public class SQLQuery {
	...
	public static final String FETCH_MEDIA_PATH_BY_MEDIA_ID = "SELECT " + MediaStoreTable.COL_MEDIA_PATH + " FROM "
			+ MediaStoreTable.TABLE_NAME + " WHERE " + MediaStoreTable.COL_MEDIA_ID + " = ?";
	...
	public static final String SQL_TRUNCATE_UNDELIVERD_STANZA_TABLE = "TRUNCATE TABLE "
			+ UndeliverStanzaTable.TABLE_NAME;
