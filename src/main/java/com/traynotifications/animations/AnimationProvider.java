...
/**
 * A provider class that houses all animation objects that implement
 * TrayAnimation This makes it easier to lookup any existing animations and
 * retrieve them This means the user can easily switch animations, and in the
 * background all possible animation types Are stores in here, so when a user
 * selects an animation type, this class will return the TrayAnimation that
 * satisfies that request It's much like a mini database
 */
